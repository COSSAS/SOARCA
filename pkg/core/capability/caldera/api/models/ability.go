...
// Validate validates this ability
func (m *Ability) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Ability) validateAccess(formats strfmt.Registry) error {
...
func (m *Ability) validateExecutors(formats strfmt.Registry) error {
...
func (m *Ability) validateRequirements(formats strfmt.Registry) error {
...
// ContextValidate validate this ability based on the context it is used
func (m *Ability) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Ability) contextValidateAccess(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *Ability) contextValidateExecutors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ability) contextValidateRequirements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ability) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Ability) UnmarshalBinary(b []byte) error {
	var res Ability
