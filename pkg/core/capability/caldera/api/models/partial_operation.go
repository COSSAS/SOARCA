...
//
// swagger:model Partial-Operation
...
// Validate validates this partial operation
func (m *PartialOperation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PartialOperation) validateAdversary(formats strfmt.Registry) error {
...
func (m *PartialOperation) validateHostGroup(formats strfmt.Registry) error {
...
func (m *PartialOperation) validateObjective(formats strfmt.Registry) error {
...
func (m *PartialOperation) validatePlanner(formats strfmt.Registry) error {
...
func (m *PartialOperation) validateSource(formats strfmt.Registry) error {
...
// ContextValidate validate this partial operation based on the context it is used
func (m *PartialOperation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PartialOperation) contextValidateAdversary(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialOperation) contextValidateHostGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialOperation) contextValidateObjective(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialOperation) contextValidatePlanner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialOperation) contextValidateSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialOperation) contextValidateStart(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialOperation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PartialOperation) UnmarshalBinary(b []byte) error {
	var res PartialOperation
