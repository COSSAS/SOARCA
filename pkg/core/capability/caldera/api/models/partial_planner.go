...
// PartialPlanner partial planner
//
// swagger:model Partial-Planner
type PartialPlanner struct {
...
// Validate validates this partial planner
func (m *PartialPlanner) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PartialPlanner) validateStoppingConditions(formats strfmt.Registry) error {
...
// ContextValidate validate this partial planner based on the context it is used
func (m *PartialPlanner) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PartialPlanner) contextValidateStoppingConditions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PartialPlanner) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PartialPlanner) UnmarshalBinary(b []byte) error {
	var res PartialPlanner
