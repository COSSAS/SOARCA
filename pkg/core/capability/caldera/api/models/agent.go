...
func (m *Agent) contextValidateCreated(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Agent) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Agent) contextValidateLastSeen(ctx context.Context, formats strfmt.Registry) error {
