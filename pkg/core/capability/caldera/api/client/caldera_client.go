...
import (
	...
	"soarca/internal/capability/caldera/api/client/adversaries"
	"soarca/internal/capability/caldera/api/client/agents"
	"soarca/internal/capability/caldera/api/client/config"
	"soarca/internal/capability/caldera/api/client/contacts"
	"soarca/internal/capability/caldera/api/client/facts"
	"soarca/internal/capability/caldera/api/client/health"
	"soarca/internal/capability/caldera/api/client/obfuscators"
	"soarca/internal/capability/caldera/api/client/objectives"
	"soarca/internal/capability/caldera/api/client/operationsops"
	"soarca/internal/capability/caldera/api/client/payloads"
	"soarca/internal/capability/caldera/api/client/planners"
	"soarca/internal/capability/caldera/api/client/plugins"
	"soarca/internal/capability/caldera/api/client/relationships"
	"soarca/internal/capability/caldera/api/client/schedules"
	"soarca/internal/capability/caldera/api/client/sources"
)
