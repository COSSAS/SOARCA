...
func TestSimpleQuery(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".library")
...
func TestLengthQuery(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".books | length")
	assert.Equal(t, err, nil)
...
func TestMultiItem(t *testing.T) {
	...
	jq := New()
	result, err := jq.Execute(object, ".books[].title")
	assert.Equal(t, err, nil)
...
func TestMap(t *testing.T) {
	...
	jq := New()
	result, err := jq.Execute(object, ".books | map(.checked_out) | add")
	assert.Equal(t, err, nil)
...
func TestBool(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".open")
	assert.Equal(t, err, nil)
...
func TestNullOnMissingField(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".nonexistent")
	assert.Equal(t, err, nil)
...
func TestNonIntegerFloat(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".books[0].copies / 2")
	assert.Equal(t, err, nil)
...
func TestArrayValue(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".books[0].genres")
	assert.Equal(t, err, nil)
...
func TestObjectValue(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".books[1] | {title, year}")
	assert.Equal(t, err, nil)
...
func TestMultiItemNumbers(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".books[].copies")
	assert.Equal(t, err, nil)
...
func TestSelectFilter(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, `.books[] | select(.checked_out == 0) | .title`)
	assert.Equal(t, err, nil)
...
func TestFlattenAndUnique(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, `[.books[].genres[]] | unique`)
	assert.Equal(t, err, nil)
...
func TestBigInteger(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, "100000000000000000000")
	assert.Equal(t, err, nil)
...
func TestInvalidJSON(t *testing.T) {
	jq := New()
	result, err := jq.Execute("{not valid json", ".library")
...
func TestParseError(t *testing.T) {
	jq := New()
	result, err := jq.Execute(object, ".books[")
	assert.NotEqual(t, err, nil)
	assert.Equal(t, result, "")
}
...
func TestRuntimeError(t *testing.T) {
	jq := New()
	_, err := jq.Execute(object, ".books | .title")
	assert.NotEqual(t, err, nil)
}
