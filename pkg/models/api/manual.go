...
type InteractionCommandData struct {
	...
	StepExecutionId string                      `bson:"step_execution_id" json:"step_execution_id" validate:"required"`  // The id of this specific step invocation. Distinguishes concurrent/repeated pending commands that share the same StepId (e.g. overlapping loop iterations)
