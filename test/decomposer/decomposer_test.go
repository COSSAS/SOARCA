...
func TestExecutePlaybook(t *testing.T) {
	...
	playbook := cacao.Playbook{
		...
		AgentDefinitions:              map[string]cacao.Target{"agent1": expectedAgent},
		TargetDefinitions:             map[string]cacao.Target{"target1": expectedTarget},
