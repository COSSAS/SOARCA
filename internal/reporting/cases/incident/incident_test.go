...
func TestCreateCase(t *testing.T) {
	...
	meta := run.Metadata{RunId: uuid.MustParse("01983c5a-067f-7016-a29b-10801077e6d6"),
...
func TestDouble(t *testing.T) {
	...
	meta1 := run.Metadata{RunId: uuid.MustParse("01983c5a-067f-7016-a29b-10801077e6d6"),
		PlaybookId: "some-playbook",
		StepId:     "SomeStep"}
	...
	ip1 := observable.Observable{Type: observable.SourceAddressIpv4,
		Name:       "__DESTINATION_IPV4__",
		Value:      "10.0.0.1",
		Runs: observable.Runs{meta1.RunId: observable.Initial}}
	...
	meta2 := run.Metadata{RunId: uuid.MustParse("01983c5a-067f-7016-a29b-10801077e6d6"),
		PlaybookId: "some-playbook",
		StepId:     "SomeStep"}
