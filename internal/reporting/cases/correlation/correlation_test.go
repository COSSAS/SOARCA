...
func TestCorrelation(t *testing.T) {
	...
	meta := run.Metadata{RunId: uuid.MustParse("01983c7b-2983-7b7d-b3bb-548d2b5d7a2a"),
...
func TestAddSecondCorrelation(t *testing.T) {
	...
	meta2 := run.Metadata{RunId: uuid.MustParse("01983caa-3cd6-704b-9598-ee9424166ead"),
		PlaybookId: "some-playbook",
		StepId:     "SomeStep"}
	...
	ob1 := observable.Observable{Type: observable.SourceAddressIpv4,
		Name:       var1.Name,
		Value:      var1.Value,
		Runs: observable.Runs{meta.RunId: observable.Initial}}
	...
	ob2 := observable.Observable{Type: observable.SourceAddressIpv4,
		Name:       var2.Name,
		Value:      var2.Value,
		Runs: observable.Runs{meta2.RunId: observable.Initial}}
