...
import (
	...
	manual_handler "soarca/internal/transport/http/handlers/manual"
	playbook_handler "soarca/internal/transport/http/handlers/playbook"
	reporter_handler "soarca/internal/transport/http/handlers/reporter"
	status_handler "soarca/internal/transport/http/handlers/status"
...
func NewManualHandler(inbox orchestrator.ManualInbox) *manual_handler.ManualHandler {
...
func PlaybookRoutesWithService(route *gin.Engine, svc orchestrator.PlaybookService) {
...
func ReporterRoutesWithService(route *gin.Engine, runner runs.Runner) {
	...
	{
		reportRoutes.GET("/", reportHandler.GetRuns)
		reportRoutes.GET("/:id", reportHandler.GetRunReport)
	}
}
