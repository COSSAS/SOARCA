...
import (
	...
	"soarca/internal/store/storagetest"
	"soarca/internal/transport/http/handlers/fin"
	"soarca/internal/workflow/capability"
	fincapability "soarca/internal/workflow/capability/fin"
	"soarca/internal/workflow/capability/fin/queue"
	"soarca/pkg/cacao"
	finmodels "soarca/pkg/fins/protocol"
...
func TestFullFinProtocolFlow(t *testing.T) {
	...
	metadata := run.Metadata{
		...
		StepId:     "action--e2e",
		StepRunId:  uuid.MustParse("55555555-5555-5555-5555-555555555555"),
	}
	...
	assert.Equal(t, pollResponse.Job.RunId, runId)
