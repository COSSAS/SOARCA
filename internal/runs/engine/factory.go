...
import (
	...
	fincap "soarca/internal/workflow/capability/fin"
	"soarca/internal/workflow/capability/fin/queue"
	httpcap "soarca/internal/workflow/capability/http"
	manualcap "soarca/internal/workflow/capability/manual"
	"soarca/internal/workflow/capability/manual/inbox"
	openc2cap "soarca/internal/workflow/capability/openc2"
	pscap "soarca/internal/workflow/capability/powershell"
	sshcap "soarca/internal/workflow/capability/ssh"
	actionexec "soarca/internal/workflow/steps/action"
	condexec "soarca/internal/workflow/steps/condition"
	pbactionexec "soarca/internal/workflow/steps/playbook_action"
	"soarca/pkg/extensions/soarca/assignment"
	thehivecases "soarca/internal/adapters/thehive/cases"
	thehiveconnector "soarca/internal/adapters/thehive/common/connector"
	thehivereport "soarca/internal/adapters/thehive/reporter"
	"soarca/internal/reporting/cases"
	"soarca/internal/reporting/reporter"
	downstreamreport "soarca/internal/reporting/reporter/downstream_reporter"
...
type Deps struct {
	ManualInbox        inbox.Dispatcher
	RunState           downstreamreport.IDownStreamReporter
...
func (f *Factory) NewWalker() workflow.Walker {
	...
	man := manualcap.New(f.deps.ManualInbox)
	capabilities[man.GetType()] = &man

	report := reporter.New([]downstreamreport.IDownStreamReporter{})
	downstreamReporters := []downstreamreport.IDownStreamReporter{f.deps.RunState}
